...
<body>
    ...
    <div class="tablero-seguimiento">
        ...
        <div class="dinosaurios-iconos">
            <button onclick="slctRojo()" class="no-border"><img src="Client/imgs/minis/rojo.png" alt="Rojo" class="icono" id="ico-rojo"></button>
            <button onclick="slctCyan()" class="no-border"><img src="Client/imgs/minis/cyan.png" alt="Cyan" class="icono" id="ico-cyan"></button>
            <button onclick="slctNaranja()" class="no-border"><img src="Client/imgs/minis/naranja.png" alt="Naranja" class="icono" id="ico-naranja"></button>
            <button onclick="slctRosa()" class="no-border"><img src="Client/imgs/minis/rosa.png" alt="Rosa" class="icono" id="ico-rosa"></button>
            <button onclick="slctVerde()" class="no-border"><img src="Client/imgs/minis/verde.png" alt="Verde" class="icono" id="ico-verde"></button>
            <button onclick="slctAzul()" class="no-border"><img src="Client/imgs/minis/azul.png" alt="Azul" class="icono" id="ico-azul"></button>
        </div>
        </div>
    </div>
